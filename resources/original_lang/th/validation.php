...
return array(
    ...
    'attributes'  => array(
        ...
        'push_notification' => 'การแจ้งเตือนแบบพุชของแอป',
        ...
        'popup_notification' => 'การแจ้งเตือนแบบป๊อปอัป',
        'allow_user_change_plan' => 'อนุญาตให้ผู้ใช้เปลี่ยนแผน',
        'only_one_session' => 'เพียงหนึ่งเซสชั่นเท่านั้น',
        'value' => 'ค่า',
        'bitcut_start' => 'เริ่มหน่อย',
        'bitcut_count' => 'จำนวนบิต',
        'move_duration_longer_than' => 'ระยะเวลาในการเคลื่อนย้ายนานกว่า',
        'min_parking_duration' => 'ระยะเวลาการจอดรถขั้นต่ำ',
        'model_id' => 'แบบอย่าง',
        'min_load_duration' => 'ระยะเวลาโหลดขั้นต่ำ',
        'min_detect_change' => 'การเปลี่ยนแปลงขั้นต่ำในการตรวจจับ',
        'role_id' => 'บทบาท',
        'on_collision' => 'เมื่อชนกัน',
        'launcher' => 'ตัวเปิด',
        'processed' => 'ดำเนินการแล้ว',
        'created_at' => 'สร้างเมื่อ',
        'reserved_at' => 'จองได้ที่',
        'completed_at' => 'เสร็จสิ้นที่',
        'failed_at' => 'ล้มเหลวที่',
        'pickup_time_from' => 'เวลารับจาก',
        'pickup_time_to' => 'เวลารับถึง',
        'delivery_time_from' => 'ระยะเวลาจัดส่งตั้งแต่',
        'delivery_time_to' => 'ระยะเวลาจัดส่งถึง',
        'task_set_id' => 'ชุดงาน',
        'firebase_config' => 'การกำหนดค่า Firebase',
    ),
    ...
    'pay_provider_min_charge' => 'จำนวนเงินขั้นต่ำสำหรับการเรียกเก็บเงินกับ :pay_provider คือ :amount',
    'formula' => 'สูตรไม่ถูกต้อง',
    'gt'  => array(
    ...
    'gte'  => array(
        ...
        'string' => ':attribute ต้องมากกว่าหรือเท่ากับอักขระ :value',
    ...
    'special_character' => 'ต้องใช้อักขระพิเศษ',
    'task_set_dedicated_to_device' => 'ชุดงานมีไว้สำหรับ :device อุปกรณ์',
    'tasks_only_one_device' => 'งานสามารถอยู่ในอุปกรณ์เครื่องเดียวเท่านั้น',
);