...
return array(
    ...
    'attributes'  => array(
        ...
        'push_notification' => 'Push-уведомление приложения',
        ...
        'allow_user_change_plan' => 'Разрешить смену плана пользователя',
        'only_one_session' => 'Только один сеанс',
        'value' => 'Ценить',
        'bitcut_start' => 'Начало бита',
        'bitcut_count' => 'Количество битов',
        'move_duration_longer_than' => 'Длительность перемещения превышает',
        'min_parking_duration' => 'Минимальная продолжительность парковки',
        'model_id' => 'Модель',
        'min_load_duration' => 'Минимальная продолжительность нагрузки',
        'min_detect_change' => 'Минимальное изменение для обнаружения',
        'role_id' => 'Роль',
        ...
        'failed_at' => 'Ошибка в',
        'pickup_time_from' => 'Время получения от',
        'pickup_time_to' => 'Время встречи до',
        'delivery_time_from' => 'Срок доставки от',
        'delivery_time_to' => 'Срок доставки до',
        'task_set_id' => 'Набор задач',
        'firebase_config' => 'Конфигурация Firebase',
    ),
    ...
    'pay_provider_min_charge' => 'Минимальная сумма списаний с помощью :pay_provider составляет :amount',
    ...
    'lte'  => array(
        ...
        'string' => 'Значение :attribute должно быть меньше или равно символу :value .',
        'array' => ':attribute не должен содержать более :value элементов.',
    ),
    'special_character' => 'Требуется специальный символ',
    'task_set_dedicated_to_device' => 'Набор задач посвящен :device устройству.',
    'tasks_only_one_device' => 'Задачи могут принадлежать только одному устройству',
);