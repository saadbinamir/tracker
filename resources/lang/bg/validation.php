...
return array(
    ...
    'attributes'  => array(
        ...
        'push_notification' => 'Приложение Push известие',
        ...
        'popup_notification' => 'Изскачащо известие',
        'allow_user_change_plan' => 'Позволете на потребителя да промени плана',
        'only_one_session' => 'Само една сесия',
        'value' => 'Стойност',
        'bitcut_start' => 'Малко начало',
        'bitcut_count' => 'Брой битове',
        'move_duration_longer_than' => 'Продължителност на движение по-голяма от',
        'min_parking_duration' => 'Минимална продължителност на паркирането',
        'model_id' => 'Модел',
        'min_load_duration' => 'Мин. продължителност на натоварване',
        'min_detect_change' => 'Минимална промяна за откриване',
        'role_id' => 'Роля',
        'on_collision' => 'При сблъсък',
        'launcher' => 'Стартер',
        'processed' => 'Обработени',
        'created_at' => 'Създаден на',
        'reserved_at' => 'Запазено в',
        'completed_at' => 'Завършен на',
        'failed_at' => 'Неуспешно при',
        'pickup_time_from' => 'Време на вземане от',
        'pickup_time_to' => 'Време за вземане до',
        'delivery_time_from' => 'Срок на доставка от',
        'delivery_time_to' => 'Време за доставка до',
        'task_set_id' => 'Комплект задачи',
        'firebase_config' => 'Конфигурация на Firebase',
    ),
    ...
    'secure_password' => 'Сигурна парола',
    ...
    'pay_provider_min_charge' => 'Минималната сума за такси с :pay_provider е :amount',
    'formula' => 'Невалидна формула',
    'gt'  => array(
    ...
    'special_character' => 'Изисква се специален знак',
    'task_set_dedicated_to_device' => 'Комплектът задачи е посветен на :device устройство',
    'tasks_only_one_device' => 'Задачите могат да принадлежат само на едно устройство',
);