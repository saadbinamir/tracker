function MapTiles() {
    var
        ...
        _maps = {
            ...
            51: {
                ...
                tile: function() {
                    var _tileLayer = new L.TileLayer('https://mt0.google.com/vt/lyrs=m&hl=' + app.lang.locale + '&x={x}&y={y}&z={z}&s=Ga&gl=' + app.lang.locale, {
                        maxZoom: 21,
                        minZoom: 0,
                        attribution: '<a href="https://seosmartec.com/" target="_system">Seosmart Ecuador</a>'
                    });
            ...
            52: {
                name: 'Google Trafico B',
                maxZoom: 21,
                tile: function() {
                    var _tileLayer = new L.TileLayer('https://mt0.google.com/vt/lyrs=m,traffic&hl=' + app.lang.locale + '&x={x}&y={y}&z={z}&s=Ga&gl=' + app.lang.locale, {
                        maxZoom: 21,
                        minZoom: 0,
                        attribution: '<a href="https://seosmartec.com/" target="_system">Seosmart Ecuador</a>'
                    });

                    _tileLayer.map_id = 52;
