<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            {!! Form::label('expire_notification[days_before]', trans('admin.expire_notification_before_days') . ' / ' . trans('admin.repeat_in'), ['class' => 'col-xs-12 col-sm-4 control-label"']) !!}
            ...
            <div class="col-xs-12 col-sm-4">
                <div class="input-group">
                    {!! Form::select('expire_notification[repeat_expiring_each_days]', $repeat_expire_time_options, $settings['expire_notification']['repeat_expiring_each_days'], ['class' => 'form-control']) !!}
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-4">
                <div class="input-group">
                    {!! Form::select('expire_notification[repeat_expired_each_days]', $repeat_expire_time_options, $settings['expire_notification']['repeat_expired_each_days'], ['class' => 'form-control']) !!}
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            {!! Form::label(null, trans('validation.attributes.firebase_config'), ['class' => 'col-xs-12 col-sm-4 control-label"']) !!}
            <div class="col-xs-12 col-sm-8">
                <div class="input-group">
                    @inject('firebaseConfig', Tobuli\Helpers\FirebaseConfig::class)
                    @if ($firebaseConfig->isCustomConfig())
                        {!! Form::text(null, 'firebase-config.json', ['class' => 'form-control', 'readonly' => true]) !!}
                        <span class="input-group-btn">
                            <a type="button" class="btn btn-default" href="{!! route('admin.main_server_settings.firebase.index') !!}">
                        ...
                        <span class="input-group-btn">
                            <a type="button"
                               ...
                               href="{!! route('admin.main_server_settings.firebase.destroy', ['action' => 'proceed']) !!}"
                               data-confirm="{{ trans('admin.do_delete') }}"
                            >
                                <i class="fa fa-trash" title="{{ trans('global.delete') }}"></i>
                            </a>
                        </span>
                    @else
                        {!! Form::text(null, 'N/A', ['class' => 'form-control', 'readonly' => true]) !!}
                    @endif
                    <span class="input-group-btn">
                        <label for="firebase_config" class="btn btn-primary"><i class="icon upload"></i></label>
                    </span>
                </div>
            </div>
        </div>
        ...
        {!! Form::open(['route' => 'admin.main_server_settings.firebase.store', 'method' => 'POST', 'id' => 'firebase-form', 'enctype' => 'multipart/form-data']) !!}
        {!! Form::file('file', ['class' => 'hidden', 'id' => 'firebase_config', 'accept' => '.json', 'onChange' => 'form.submit()']) !!}
        {!! Form::close() !!}
    </div>
