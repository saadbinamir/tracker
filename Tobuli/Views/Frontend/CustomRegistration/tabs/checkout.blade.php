...
<div class="row">
    <div class="col-xs-12 col-sm-offset-2 col-sm-8">
        ...
        <ul class="list-group">
            ...
            <li class="list-group-item">
                <div>
                    <a href="javascript:" data-url="{{ route('pages.show', 'refund') }}" data-modal="pages">
                        Refund and cancellation terms accept
                    </a>
                    <div class="checkbox-inline">
                        {!! Form::checkbox(null, 1, false, ['id' => 'refund_cancellation']) !!}
                        {!! Form::label(null, null) !!}
                    </div>

                    <a href="javascript:" data-url="{{ route('pages.show', 'terms_conditions') }}" data-modal="pages">
                        Terms of service
                    </a>
                    <div class="checkbox-inline">
                        {!! Form::checkbox(null, 1, false, ['id' => 'terms_conditions']) !!}
                        {!! Form::label(null, null) !!}
                    </div>
                </div>

                <span id="error-terms" class="help-block error" style="display: none">Please accept the terms and conditions</span>
            </li>
        </ul>
    </div>
</div>
...
<script>
    ...
    form.addEventListener('submit', function (event) {
        ...
        if(!$('#terms_conditions').is(':checked') && !$('#refund_cancellation').is(':checked')) {
            $('#error-terms').show();
            return;
        } else {
            $('#error-terms').hide();
