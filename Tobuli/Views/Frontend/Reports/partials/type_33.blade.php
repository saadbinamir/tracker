                            ...
                            <td width="50%">
                                <table class="table" style="padding: 10px">
                                    ...
                                    <tr>
                                        ...
                                        <td class="bottomline">
                                            @php
                                                $distance = floatval($item['totals']['distance']['value'] ?? 0);
                                                $overspeed = floatval($item['totals']['overspeed_distance']['value'] ?? 0);
                                            @endphp
                                            @if (!empty($distance) && !empty($overspeed))
                                            {{ round(100 - ($overspeed / $distance * 100), 1) }}
                                            @else
                                            0
                                            @endif
                                        </td>
