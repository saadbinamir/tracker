...
@section('body')
    ...
    <div class="tab-content">
        ...
        <div id="setup-form-sms-gateway" class="tab-pane">
            @php
                $smsEditDisable = Auth::user()->perm('sms_gateway', 'edit') ? [] : ['disabled' => 'disabled'];
            @endphp

            <div class="form-group">
                <div class="checkbox">
                    {!! Form::checkbox('sms_gateway', 1, $item['sms_gateway'], $smsEditDisable) !!}
            ...
            <div class="form-group">
                ...
                {!!Form::select('request_method', $request_method_select, $item['sms_gateway_params']['request_method'], ['class' => 'form-control'] + $smsEditDisable)!!}
            </div>
            <div class="request-method request-method-post">
                <div class="form-group">
                    {!!Form::label('encoding', trans('validation.attributes.encoding').':')!!}
                    {!!Form::select('encoding', $encoding_select, $item['sms_gateway_params']['encoding'], ['class' => 'form-control'] + $smsEditDisable)!!}
                </div>
            </div>
            <div class="request-method request-method-get request-method-post">
                <div class="form-group">
                    ...
                    {!!Form::select('authentication', $authentication_select, $item['sms_gateway_params']['authentication'], ['class' => 'form-control'] + $smsEditDisable)!!}
                </div>
                <div class="form-group sms-gateway-auth">
                    {!!Form::label('username', trans('validation.attributes.username').':')!!}
                    {!!Form::text('username', $item['sms_gateway_params']['username'], ['class' => 'form-control'] + $smsEditDisable)!!}
                </div>
                <div class="form-group sms-gateway-auth">
                    {!!Form::label('password', trans('validation.attributes.password').':')!!}
                    {!!Form::password('password', ['class' => 'form-control'] + $smsEditDisable)!!}
                </div>
                <div class="form-group">
                    {!!Form::label('custom_headers', trans('validation.attributes.sms_gateway_headers').':')!!}
                    {!!Form::textarea('custom_headers', $item['sms_gateway_params']['custom_headers'], ['class' => 'form-control', 'rows' => 2] + $smsEditDisable)!!}
                ...
                <div class="form-group">
                    ...
                    {!!Form::textarea('sms_gateway_url', $item['sms_gateway_url'], ['class' => 'form-control', 'rows' => 3] + $smsEditDisable)!!}
                </div>
            ...
            <div class="request-method request-method-plivo">
                <div class="form-group">
                    ...
                    {!! Form::text('auth_id', (isset($item['sms_gateway_params']['auth_id']) ? $item['sms_gateway_params']['auth_id'] : null), ['class' => 'form-control'] + $smsEditDisable) !!}
                </div>
                <div class="form-group">
                    {!! Form::label('auth_token', trans('validation.attributes.auth_token').':') !!}
                    {!! Form::text('auth_token', (isset($item['sms_gateway_params']['auth_token']) ? $item['sms_gateway_params']['auth_token'] : null), ['class' => 'form-control'] + $smsEditDisable) !!}
                </div>
                <div class="form-group">
                    {!! Form::label('senders_phone', trans('validation.attributes.senders_phone').':') !!}
                    {!! Form::text('senders_phone', (isset($item['sms_gateway_params']['senders_phone']) ? $item['sms_gateway_params']['senders_phone'] : null), ['class' => 'form-control'] + $smsEditDisable) !!}
                </div>
        ...
        <div id="setup-form-widgets" class="tab-pane">
            <div class="form-group">
                <div class="checkbox">
                    {!! Form::hidden('widgets[default]', 0) !!}
                    {!! Form::checkbox('widgets[default]', 1, !empty($widgets['default']), ['id' => 'default_widgets']) !!}
                    {!! Form::label('widgets[default]', trans('front.default') . ' ' .trans('front.widgets')) !!}
                </div>
    ...
    <script>
        ...
        $('#default_widgets', $settings_container).trigger('change');
