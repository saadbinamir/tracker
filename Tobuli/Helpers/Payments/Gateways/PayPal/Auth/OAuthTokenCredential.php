...
namespace Tobuli\Helpers\Payments\Gateways\PayPal\Auth;

use Tobuli\Helpers\Payments\Gateways\PayPal\Cache\AuthorizationCache;
...
use Tobuli\Helpers\Payments\Gateways\PayPal\Handler\IPayPalHandler;
use Tobuli\Helpers\Payments\Gateways\PayPal\Rest\ApiContext;
use Tobuli\Helpers\Payments\Gateways\PayPal\Security\Cipher;
...
class OAuthTokenCredential extends PayPalResourceModel
{
     ...
     */
    public static $AUTH_HANDLER = 'Tobuli\Helpers\Payments\Gateways\PayPal\Handler\OauthHandler';
