 ...
 *
 * @property string id
 * @property \Tobuli\Helpers\Payments\Gateways\PayPal\Api\FundingSource[] funding_sources
 * @property \Tobuli\Helpers\Payments\Gateways\PayPal\Api\FundingInstrument backup_funding_instrument
 * @property \Tobuli\Helpers\Payments\Gateways\PayPal\Api\CurrencyConversion currency_conversion
 * @property \Tobuli\Helpers\Payments\Gateways\PayPal\Api\InstallmentInfo installment_info
...
class FundingOption extends PayPalModel
{
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\FundingSource[] $funding_sources
     * 
     * @return $this
     */
     ...
     * List of funding sources that contributes to a payment.
     *
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\FundingSource[]
     */
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\FundingSource $fundingSource
     * @return $this
     */
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\FundingInstrument $backup_funding_instrument
     * 
     * @return $this
     */
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\CurrencyConversion $currency_conversion
     * 
     * @return $this
     */
     ...
     * Currency conversion applicable to this funding option.
     *
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\CurrencyConversion
     */
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\InstallmentInfo $installment_info
     * 
     * @return $this
     */
     ...
     * Installment options available for a funding option.
     *
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\InstallmentInfo
     */
