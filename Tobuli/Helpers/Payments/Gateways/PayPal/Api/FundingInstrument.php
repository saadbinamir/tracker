 ...
 *
 * @property \Tobuli\Helpers\Payments\Gateways\PayPal\Api\CreditCard credit_card
 * @property \Tobuli\Helpers\Payments\Gateways\PayPal\Api\CreditCardToken credit_card_token
 * @property \Tobuli\Helpers\Payments\Gateways\PayPal\Api\Billing billing
 */
class FundingInstrument extends PayPalModel
{
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\CreditCard $credit_card
     *
     * @return $this
     */
     ...
     * Credit Card instrument.
     *
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\CreditCard
     */
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\CreditCardToken $credit_card_token
     *
     * @return $this
     */
     ...
     * PayPal vaulted credit Card instrument.
     *
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\CreditCardToken
     */
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\PaymentCard $payment_card
     *
     * @return $this
     */
     ...
     * Payment Card information.
     *
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\PaymentCard
     */
     ...
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\ExtendedBankAccount $bank_account
     *
     * @return $this
     */
     ...
     * Bank Account information.
     * @deprecated Not publicly available
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\ExtendedBankAccount
     */
     ...
     * @deprecated Not publicly available
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\BankToken $bank_account_token
     *
     * @return $this
     */
     ...
     * Vaulted bank account instrument.
     * @deprecated Not publicly available
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\BankToken
     */
     ...
     * @deprecated Not publicly available
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\Credit $credit
     *
     * @return $this
     */
     ...
     * PayPal credit funding instrument.
     * @deprecated Not publicly available
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\Credit
     */
     ...
     * @deprecated Not publicly available
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\Incentive $incentive
     *
     * @return $this
     */
     ...
     * Incentive funding instrument.
     * @deprecated Not publicly available
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\Incentive
     */
     ...
     * @deprecated Not publicly available
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\ExternalFunding $external_funding
     *
     * @return $this
     */
     ...
     * External funding instrument.
     * @deprecated Not publicly available
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\ExternalFunding
     */
     ...
     * @deprecated Not publicly available
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\CarrierAccountToken $carrier_account_token
     *
     * @return $this
     */
     ...
     * Carrier account token instrument.
     * @deprecated Not publicly available
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\CarrierAccountToken
     */
     ...
     * @deprecated Not publicly available
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\CarrierAccount $carrier_account
     *
     * @return $this
     */
     ...
     * Carrier account instrument
     * @deprecated Not publicly available
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\CarrierAccount
     */
     ...
     * @deprecated Not publicly available
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\PrivateLabelCard $private_label_card
     *
     * @return $this
     */
     ...
     * Private Label Card funding instrument. These are store cards provided by merchants to drive business with value to customer with convenience and rewards.
     * @deprecated Not publicly available
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\PrivateLabelCard
     */
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\Billing $billing
     *
     * @return $this
     */
     ...
     * Billing instrument that references pre-approval information for the payment
     *
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\Billing
     */
     ...
     *
     * @deprecated Not publicly available
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\AlternatePayment $alternate_payment
     *
     * @return $this
     */
     ...
     *
     * @deprecated Not publicly available
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\AlternatePayment
     */
