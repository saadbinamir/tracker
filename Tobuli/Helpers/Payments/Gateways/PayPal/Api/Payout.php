 ...
 *
 * @property \Tobuli\Helpers\Payments\Gateways\PayPal\Api\PayoutSenderBatchHeader sender_batch_header
 * @property \Tobuli\Helpers\Payments\Gateways\PayPal\Api\PayoutItem[] items
...
class Payout extends PayPalResourceModel
{
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\PayoutSenderBatchHeader $sender_batch_header
     *
     * @return $this
     */
     ...
     * The original batch header as provided by the payment sender.
     *
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\PayoutSenderBatchHeader
     */
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\PayoutItem[] $items
     *
     * @return $this
     */
     ...
     * An array of payout items (that is, a set of individual payouts).
     *
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\PayoutItem[]
     */
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\PayoutItem $payoutItem
     * @return $this
     */
