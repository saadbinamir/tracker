...
use Tobuli\Helpers\Payments\Gateways\PayPal\Transport\PayPalRestCall;
 ...
 * @property \Tobuli\Helpers\Payments\Gateways\PayPal\Api\Participant[] cc_info
 ...
 * @property \Tobuli\Helpers\Payments\Gateways\PayPal\Api\PaymentDetail[] payments
 * @property \Tobuli\Helpers\Payments\Gateways\PayPal\Api\RefundDetail[] refunds
 * @property \Tobuli\Helpers\Payments\Gateways\PayPal\Api\Metadata metadata
 * @property \Tobuli\Helpers\Payments\Gateways\PayPal\Api\PaymentSummary paid_amount
 * @property \Tobuli\Helpers\Payments\Gateways\PayPal\Api\PaymentSummary refunded_amount
...
class Invoice extends PayPalResourceModel
{
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\Participant[] $cc_info
     * 
     * @return $this
     */
     ...
     * For invoices sent by email, one or more email addresses to which to send a Cc: copy of the notification. Supports only email addresses under participant.
     *
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\Participant[]
     */
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\Participant $participant
     * @return $this
     */
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\PaymentDetail[] $payments
     * 
     * @return $this
     */
     ...
     * List of payment details for the invoice.
     *
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\PaymentDetail[]
     */
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\PaymentDetail $paymentDetail
     * @return $this
     */
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\RefundDetail[] $refunds
     * 
     * @return $this
     */
     ...
     * List of refund details for the invoice.
     *
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\RefundDetail[]
     */
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\RefundDetail $refundDetail
     * @return $this
     */
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\Metadata $metadata
     * 
     * @return $this
     */
     ...
     * Audit information for the invoice.
     *
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\Metadata
     */
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\PaymentSummary $paid_amount
     * 
     * @return $this
     */
     ...
     * Payment summary of the invoice including amount paid through PayPal and other sources.
     *
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\PaymentSummary
     */
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\PaymentSummary $refunded_amount
     * 
     * @return $this
     */
