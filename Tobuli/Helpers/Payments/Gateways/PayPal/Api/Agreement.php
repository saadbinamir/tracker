 ...
 * @property \Tobuli\Helpers\Payments\Gateways\PayPal\Api\Address shipping_address
 * @property \Tobuli\Helpers\Payments\Gateways\PayPal\Api\MerchantPreferences override_merchant_preferences
 * @property \Tobuli\Helpers\Payments\Gateways\PayPal\Api\OverrideChargeModel[] override_charge_models
 * @property \Tobuli\Helpers\Payments\Gateways\PayPal\Api\Plan plan
 * @property string create_time
 * @property string update_time
 * @property \Tobuli\Helpers\Payments\Gateways\PayPal\Api\AgreementDetails agreement_details
 */
class Agreement extends PayPalResourceModel
{
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\Address $shipping_address
     * 
     * @return $this
     */
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\MerchantPreferences $override_merchant_preferences
     * 
     * @return $this
     */
     ...
     * Default merchant preferences from the billing plan are used, unless override preferences are provided here.
     *
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\MerchantPreferences
     */
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\OverrideChargeModel[] $override_charge_models
     * 
     * @return $this
     */
     ...
     * Array of override_charge_model for this agreement if needed to change the default models from the billing plan.
     *
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\OverrideChargeModel[]
     */
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\OverrideChargeModel $overrideChargeModel
     * @return $this
     */
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\Plan $plan
     * 
     * @return $this
     */
     ...
     * Plan details for this agreement.
     *
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\Plan
     */
     ...
     * Agreement Details
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\AgreementDetails $agreement_details
     * 
     * @return $this
     */
     ...
     * Agreement Details
     *
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\AgreementDetails
     */
