 ...
 *
 * @property \Tobuli\Helpers\Payments\Gateways\PayPal\Api\Item[] items
 * @property \Tobuli\Helpers\Payments\Gateways\PayPal\Api\ShippingAddress shipping_address
...
class ItemList extends PayPalModel
{
     ...
     * List of items.
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\Item[] $items
     * 
     * @return $this
     */
     ...
     * List of items.
     *
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\Item[]
     */
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\Item $item
     * @return $this
     */
     ...
     * Shipping address.
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\ShippingAddress $shipping_address
     * 
     * @return $this
     */
     ...
     * Shipping address.
     *
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\ShippingAddress
     */
