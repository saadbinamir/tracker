 ...
 * @property \Tobuli\Helpers\Payments\Gateways\PayPal\Api\InstallmentOption[] installment_options
 */
class InstallmentInfo extends PayPalModel
{
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\InstallmentOption[] $installment_options
     * 
     * @return $this
     */
     ...
     * List of available installment options and the cost associated with each one.
     *
     * @return \Tobuli\Helpers\Payments\Gateways\PayPal\Api\InstallmentOption[]
     */
     ...
     *
     * @param \Tobuli\Helpers\Payments\Gateways\PayPal\Api\InstallmentOption $installmentOption
     * @return $this
     */
