...
use Tobuli\Helpers\Payments\Gateways\PayPal\Rest\IResource;
...
class PayPalResourceModel extends PayPalModel implements IResource
{
     ...
     */
    protected static function executeCall($url, $method, $payLoad, $headers = array(), $apiContext = null, $restCall = null, $handlers = array('Tobuli\Helpers\Payments\Gateways\PayPal\Handler\RestHandler'))
    {
