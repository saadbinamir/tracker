...
class EmailTemplatesTableSeeder extends Seeder {
	...
	public function run()
	{
        ...
        EmailTemplate::updateOrCreate(['name' => 'reset_password_code'], [
            ...
            'note'  => 'You are receiving this email because we received a password reset code request for your account.<br><br>[code]<br><br>If you did not request a password reset, no further action is required.',
        ]);
